...
<script type="text/javascript">
	...
	$(function(){
		...
		// 进行市场活动的关联，思路：1.根据输入框的内容，当用户点击回车键，就进行ajax请求，进行后台模糊查询
		// 给模糊查询的文本框绑定事件
		$("#relationText").click(function () {
             var tname = $.trim($("#relationText").val());// 获取文本框的值
			// 键盘敲击回车
	...
	// 创建一个跳转事件，跳转到详细信息页面,跳转前过一下后台，查询数据
	function detailList() {
		$.ajax({
			url: "workbench/clue/detailList.do",
			data:{
				"clueId":"${clue.id}"
			},
			type:"get",
...
<body>
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    <input type="text" id="relationText" class="form-control" style="width: 300px;" placeholder="请输入市场活动名称，支持模糊查询">
	...
	<div style="position: relative; top: -70px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 60px;">
			...
			<div style="width: 500px;position: relative; left: 200px; top: -20px;"><b> &nbsp;&nbsp;</b><small style="font-size: 10px; color: gray;"> </small></div>
			<div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
		</div>
